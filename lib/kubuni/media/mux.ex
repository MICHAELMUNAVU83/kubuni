defmodule Kubuni.Media.Mux do
  ...
  defp api_url, do: Application.get_env(:kubuni, :mux_api_url, "https://api.mux.com")

  defp configured_cors_origin do
    Application.get_env(:kubuni, :mux_cors_origin, "http://localhost:4000")
  end
  ...
  defp fetch_secret!(key, env_name) do
    Application.get_env(:kubuni, key) ||
