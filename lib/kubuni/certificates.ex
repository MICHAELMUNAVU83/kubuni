defmodule Kubuni.Certificates do
  @moduledoc """
  ...
  alias Kubuni.Catalog.{Course, CourseModule}
  ...
  def subscribe(%User{id: id}) do
    Phoenix.PubSub.subscribe(Kubuni.PubSub, user_topic(id))
  end
  ...
  defp renderer, do: Application.fetch_env!(:kubuni, :certificate_renderer)
  defp storage, do: Application.fetch_env!(:kubuni, :certificate_storage)
