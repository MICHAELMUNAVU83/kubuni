defmodule KubuniWeb.AdminComponents do
  @moduledoc """
  ...
  LiveViews consistent with the Kubuni design system.
  """
  use Phoenix.Component

  alias Phoenix.LiveView.JS

  import KubuniWeb.CoreComponents, only: [icon: 1]

  use Phoenix.VerifiedRoutes,
    endpoint: KubuniWeb.Endpoint,
    router: KubuniWeb.Router,
    statics: KubuniWeb.static_paths()
    ...
    <div class="min-h-screen bg-soft text-dark lg:flex">
      ...
      <div class="flex items-center justify-between border-b border-black/5 bg-white px-5 py-4 lg:hidden">
        <.link navigate={~p"/admin"} class="flex items-center gap-3 font-bold text-dark">
          ...
          <span>Kubuni <span class="text-primary">Admin</span></span>
        </.link>
        <button
          type="button"
      ...
      >
        <div class="hidden px-6 py-7 lg:block">
          <.link navigate={~p"/admin"} class="flex items-center gap-3 font-bold text-dark">
            ...
            <span class="text-lg">Kubuni <span class="text-primary">Admin</span></span>
          </.link>
        </div>
