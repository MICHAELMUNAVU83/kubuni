defmodule KubuniWeb.PaymentLive.FormComponent do
    ...
    <div>
      ...
      >
        <.input
          ...
          options={Ecto.Enum.values(Kubuni.Payments.Payment, :provider)}
        />
        ...
        <.input
          ...
          label="Status"
          prompt="Choose a value"
          options={Ecto.Enum.values(Kubuni.Payments.Payment, :status)}
        />
