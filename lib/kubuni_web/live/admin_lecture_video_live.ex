defmodule KubuniWeb.AdminLectureVideoLive do
  use KubuniWeb, :live_view

  alias Kubuni.{Catalog, Media}
      ...
      <div class="mx-auto max-w-3xl px-5 lg:px-8">
        ...
        <section class="mt-6 rounded-3xl border border-black/5 bg-white p-6 shadow-lg sm:p-10">
          ...
          <p class="mt-3 text-body">
            The file travels straight from this browser to Mux. Kubuni stores only the signed
