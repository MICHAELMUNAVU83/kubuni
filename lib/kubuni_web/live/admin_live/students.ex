defmodule KubuniWeb.AdminLive.Students do
  use KubuniWeb, :live_view

  alias Kubuni.{Accounts, Enrollments, Payments}
    ...
    <.admin_layout active={:students} current_user={@current_user}>
      <div class="mx-auto max-w-container space-y-8 px-5 py-10 lg:px-10">
        <.page_header eyebrow="People" title="Students">
          <:subtitle>Everyone who has registered on Kubuni and what they have enrolled in.</:subtitle>
        </.page_header>
