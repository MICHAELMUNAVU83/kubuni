defmodule KubuniWeb.Router do
  use KubuniWeb, :router
  ...
  # scope "/api", KubuniWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:kubuni, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: KubuniWeb.Telemetry
  ...
  scope "/", KubuniWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{KubuniWeb.UserAuth, :redirect_if_user_is_authenticated}] do
