defmodule KubuniWeb.PaystackWebhookController do
  use KubuniWeb, :controller

  alias Kubuni.Payments.Workers.ProcessPaystackWebhook
  ...
  def valid_signature?(body, signature) when is_binary(signature) do
    case Application.get_env(:kubuni, :paystack_secret_key) do
