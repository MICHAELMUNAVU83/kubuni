# Kubuni Design System

This document captures the visual language used across Kubuni. Follow it when
...
[`lib/kubuni_web/components/home_components.ex`](lib/kubuni_web/components/home_components.ex).
