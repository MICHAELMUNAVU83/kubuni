defmodule Kubuni.MediaTest do
  ...
  setup do
    ...
    previous_key = Application.get_env(:kubuni, :mux_signing_private_key)
    previous_id = Application.get_env(:kubuni, :mux_signing_key_id)

    Application.put_env(:kubuni, :mux_signing_private_key, Base.encode64(pem))
    Application.put_env(:kubuni, :mux_signing_key_id, "test-key")
  ...
  defp restore_env(key, nil), do: Application.delete_env(:kubuni, key)
  defp restore_env(key, value), do: Application.put_env(:kubuni, key, value)
end
