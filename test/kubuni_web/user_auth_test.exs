defmodule KubuniWeb.UserAuthTest do
  use KubuniWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Kubuni.Accounts
  alias KubuniWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KubuniWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      KubuniWeb.Endpoint.subscribe(live_socket_id)
